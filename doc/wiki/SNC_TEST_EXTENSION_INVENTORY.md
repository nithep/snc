...
ssh pi4 '/home/ecs-agent/nithep/snc/burnin-monitor.sh --report'

# ดูสายค้าง / เคส breach จากฐานข้อมูลโดยตรง
ssh pi4 "sqlite3 /home/ecs-agent/nithep/snc/api/nurse_call_events.db \"SELECT room_id, status, timestamp FROM nurse_call_events WHERE status IN ('active','acknowledged');\""
ssh pi4 "sqlite3 /home/ecs-agent/nithep/snc/api/nurse_call_events.db \"SELECT room_id, COUNT(*) FROM nurse_call_events WHERE sla_breached = 1 GROUP BY room_id;\""
