...
* **ไดเรกทอรีของโครงการ (WorkingDirectory):** `/home/ecs-agent/nithep/snc/`
* **ไดเรกทอรีบันทึกผลงาน (Logs Location):** `/home/ecs-agent/nithep/snc/logs/` (หรือกำหนดเก็บลง Systemd Journal เพื่อทำ Log Rotation อัตโนมัติ)
...
ExecStart=/home/ecs-agent/nithep/snc/venv/bin/python3 -m uvicorn server:app --host 0.0.0.0 --port 8000
...
ExecStart=/home/ecs-agent/nithep/snc/venv/bin/python3 snc_pbx_listener.py
...
```bash
mkdir -p /home/ecs-agent/nithep/snc/logs
sudo chown -R ecs-agent:ecs-agent /home/ecs-agent/nithep/snc/
```
