...
tail -f /home/ecs-agent/snc/backend.log
...
tail -50 /home/ecs-agent/snc/backend.log
```
...
grep "SNC Event" /home/ecs-agent/snc/pbx_listener.log
```

### Dashboard `/` 404/blank
```bash
# server.py serves static_dir = ../app — deploy app/index.html
scp app/index.html pi4:/home/ecs-agent/snc/app/
...
| File | Repo | Pi |
|------|------|----|
| Backend | `api/server.py` | `/home/ecs-agent/snc/api/server.py` |
| PBX Listener | `pbx/snc_pbx_listener.py` | `/home/ecs-agent/snc/pbx/snc_pbx_listener.py` |
| Dashboard (main) | `app/index.html` | `/home/ecs-agent/snc/app/index.html` |
| Dashboard | `app/index.html` | `/home/ecs-agent/snc/app/index.html` |
| Scripts | `ops/*.sh` | `/home/ecs-agent/snc/ops/` |
| Database | `api/nurse_call_events.db` (runtime) | `/home/ecs-agent/snc/api/nurse_call_events.db` |
| Logs | — (runtime) | `/home/ecs-agent/snc/` |
| Docs | `doc/*.md`, `doc/wiki/*.md` | `/home/ecs-agent/snc/doc/` |
...
# User=ecs-agent, WorkingDirectory=/home/ecs-agent/snc/{api,pbx}
```
...
2. **Aliases** in `~/.bashrc`:
   ```bash
   alias snc-start='cd /home/ecs-agent/snc && ./ops/start-snc-system.sh'
