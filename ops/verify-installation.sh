...
test_check "Listener log exists" "test -f /home/ecs-agent/snc/logs/pbx_listener.log"
test_check "Listener connected to PBX" "grep -q 'Connected successfully' /home/ecs-agent/snc/logs/pbx_listener.log"
echo ""
...
if [ $FAIL -eq 0 ]; then
    ...
    echo "  - View logs: tail -f /home/ecs-agent/snc/logs/*.log"
    exit 1
fi
