...
6. **ทุกโปรเจกต์ต้องมีคู่มือ rotate key**: สร้าง `doc/wiki/*_ROTATION_GUIDE.md` (เช่น [`SNC_API_KEY_ROTATION_GUIDE.md`](doc/wiki/SNC_API_KEY_ROTATION_GUIDE.md)) ครอบคลุม Pi/Server และ Client — ทุกครั้งที่เพิ่ม service ที่มี secret
